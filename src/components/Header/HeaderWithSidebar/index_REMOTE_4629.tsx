...
import { Groups, Article, AccountCircle, Timeline } from "@mui/icons-material"
            ...
            <AppBar position="fixed" open={open}>
                <Toolbar sx={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <Box component='nav' display={{ xs: 'none', md: 'initial' }}>
                        <AppButton
                            sx={{
                                height: '2.5rem', backgroundColor: '#404040', color: 'inherit', borderRadius: '.625rem', px: 2.25, py: 1.25,
                                '&:hover': {
                    ...
                    <List>
                        ...
                        <ListItem disablePadding sx={{ display: 'block' }}>
                            <ListItemButton sx={{
                                ...
                                <ListItemText primary={'Pacientes'} sx={{ opacity: open ? 1 : 0 }} />
                            </ListItemButton>
                        </ListItem>

                        <ListItem disablePadding sx={{ display: 'block' }}>
                            <ListItemButton component={NavLink} to={'/consultations'} sx={{
                                minHeight: 48,
                                justifyContent: open ? 'initial' : 'center',
                                px: 2.5,
                            }}>
